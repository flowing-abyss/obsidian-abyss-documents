 ...
 * Source: pdfjs-dist/web/pdf_viewer.css and src/styles/*.css.
 */\n`;
...
const SETTINGS_STYLES_PATH = 'src/styles/settings.css';
...
export async function buildStyles(check = false) {
  const [pdfjsStyles, readerStyles, settingsStyles] = await Promise.all([
